...
public class App extends BasicMath{
	...
	private void calculator(){
		...
		System.out.println("Welcome to my Ryan's Calculator");
		System.out.println("=============================================================");
		System.out.println("Enter 1 For Basic Calculations");
		System.out.println("Enter 2 For Advanced Calculations");
		System.out.println("Enter 3 For Memory Options");
		System.out.println("=============================================================");
		...
		if(response_value==1){
			...
			System.out.println("You are now in the calculator memory...");
			System.out.println("Enter 1 To Print the Current Memory");
			System.out.println("Enter 2 To Delete a single peice of Memory");
			System.out.println("Enter 3 To Clear All Of the Current Memory");
			...
			System.out.println("You are required to enter either a 1 or 2 only");
		}
		System.out.println("=============================================================");
